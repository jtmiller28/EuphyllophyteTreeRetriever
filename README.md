...
``` r
EuphyllophyteTreeRetriever::get_bootstrap_trees(all_trees = FALSE, # if true, gather all bootstrapped trees available
                                                num_trees = 100, # if all_trees = FALSE, specify the number of trees to pull (less than or equal to 1004)
